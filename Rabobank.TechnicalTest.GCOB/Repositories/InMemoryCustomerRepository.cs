...
namespace Rabobank.TechnicalTest.GCOB.Repositories
{
    public class InMemoryCustomerRepository : ICustomerRepository
    {
        ...
        {
            _logger = logger;
         //   Customers.TryAdd(1, new CustomerDto { Id = 1, FirstName = "John", LastName = "Smith", AddressId = 1 });
        }
        ...
        public Task<CustomerDto> InsertAsync(CustomerDto customer)
        {
        ...
        {
            return Task.FromResult(Customers.Select(x => x.Value));
        }
    }
}
